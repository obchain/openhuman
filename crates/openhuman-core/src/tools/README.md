...
| `crates/openhuman-core/src/tools/impl/browser/` | Deferred `browser` (TinyBrowser bus actions and Jev tasks), deferred `browser_open` (simple TinyBrowser entry point), and direct `image_info`. |
